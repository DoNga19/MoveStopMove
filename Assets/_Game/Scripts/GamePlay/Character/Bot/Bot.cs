...
public class Bot : Character
{
    ...
    public override void WearClothes()
    {
        ...
        ChangeWeapon(Utilities.RandomEnumValue<WeaponTypes>());
    ...
    public bool IsDestination => Vector3.Distance(TF.position, destination) - Mathf.Abs(TF.position.y - destination.y) < 0.001f;
